...
import FormAddUser from "@/Components/AdminComponents/FormAddUser.vue";
...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div v-if="$page.props.flash.error" class="bg-red-300">
            {{ $page.props.flash.error }}
        </div>
        <div v-if="$page.props.flash.success" class="bg-green-300">
            <Alert/>
        </div>
                ...
                <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                    <button type="button"
                        ...
                        <span class="flex justify-between items-center">
                            <PlusSmallIcon class="-ml-0.5 mr-2 h-4 w-4" aria-hidden="true"/>
                        Add user
                        </span>
                    </button>
                </div>
                ...
                <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                    <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                        <table class="min-w-full divide-y divide-gray-300">
                            ...
                            <tr v-for="person in employees.data" :key="person.email">
        ...
        <Pagination :current-page="employees.current_page" :next="employees.next_page_url"
                    :previous="employees.prev_page_url" :total="employees.total" :to="employees.to"
